...
namespace PrivilegeManagement.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = Configuration["PrivilegeManagementDbContextSettings:ConnectionString"];
            services.AddDbContext<PrivilegeManagementDbContext>(
